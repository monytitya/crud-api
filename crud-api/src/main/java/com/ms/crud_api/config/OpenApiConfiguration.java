...
public class OpenApiConfiguration {
    ...
    public GroupedOpenApi backendGroup() {
        return GroupedOpenApi.builder()
                ...
                .packagesToScan("com.ms.crud_api.controller.backend")
                .build();
    }
    ...
    public GroupedOpenApi frontendGroup() {
        return GroupedOpenApi.builder()
                ...
                .packagesToScan("com.ms.crud_api.controller.frontend")
                .build();
    }
    ...
    private Info getBackendApiInfo() {
        return new Info()
                .title("Ecommerce API")
                .description("Backend Ecommerce API")
                .contact(getContact())
                .version("1.0.1");
    }
    ...
    private Info getFrontendApiInfo() {
        return new Info()
                .title("Ecommerce API")
                .description("Frontend Ecommerce API")
                .contact(getContact())
                .version("1.0.1");
    }
    ...
    private Contact getContact() {
        ...
        contact.setName("Mao Titaymony");
        contact.setEmail("maotityamony789@gmail.com");
        contact.setUrl("https://github.com/monytitya");
        return contact;
    }
}
